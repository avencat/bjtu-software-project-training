    ...
    return (
      <form className="form-horizontal" onSubmit={this.props.onSubmit}>
        ...
        <div className="form-group">
          ...
          <div className="col-sm-8">
            <input className="form-control" required={this.props.passwordRequired} type="password" value={this.props.password} name='password' id="password" onChange={this.props.onChange}/>
          </div>
